...
<head>
    <meta charset="utf-8" />
    <title>创建消费返活动-<?php echo ($_domain['web_name']); ?></title>
            ...
            <div class="card-box">
                ...
                <form role="form">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>活动名称</label>
                                <input type="text" class="form-control" name="name" placeholder="最多10个汉字">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control" style="border:0">
                                    <div class="radio radio-info form-check-inline">
                                        <input type="radio"  value="1" name="fx_type" checked="">
                                        <label >分比例返现</label>
                                    </div>
                                    <div class="radio radio-info form-check-inline">
                                        <input type="radio"  value="2" name="fx_type">
                                        <label >等比例返现</label>
                                    </div>
                                    <div class="radio radio-info form-check-inline">
                                        <input type="radio"  value="3" name="fx_type">
                                        <label >百分比返现</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">消费满</span>
                                        </div>
                                        <input type="number" min="0.01" step="0.01" class="form-control" name="xf_money[]" placeholder="" >
                                        <div class="input-group-append">
                                            <span class="input-group-text"> 元,返</span>
                                        </div>
                                        <input type="number" min="0.01" step="0.01" class="form-control" name="xf_total[]" placeholder="" >
                                        <div class="input-group-append">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" min="0.01" class="form-control" name="xf2_money" placeholder="">
                                        <div class="input-group-append">
                                            <span class="input-group-text"> 元,返</span>
                                        </div>
                                        <input type="number" min="0.01" class="form-control" name="xf2_total" placeholder="">
                                        <div class="input-group-append">
                                            <span class="input-group-text"> 元</span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">返现比例</span>
                                        </div>
                                        <input type="number" min="0" class="form-control" name="xf3_money" placeholder="">
                                        <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>会员卡消费返现</label>
                                <div class="checkbox">
                                    <input id="c1" class="magic-checkbox" type="checkbox" name="hyk_xf">
                                    <label for="c1">勾选后，会员卡消费也会参与到消费返现活动中，与资金相关选项，请谨慎勾选</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>消费返现次数限制</label>
                                <input type="number"  name="xff_number" class="form-control"  placeholder="不填写则不限制">
                                <span>配置后，可限制单用户可享受消费返现活动总次数</span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $('.ac-add').click(function (e) {
            ...
            var html= " <div class=\"row acList item"+new Date().getTime()+"\">\n" +
                ...
                "                                        <span class=\"input-group-text\">消费满</span>\n" +
                "                                    </div>\n" +
                "                                    <input type=\"number\" min=\"0.01\" step=\"0.01\" class=\"form-control\" name=\"xf_money[]\" placeholder=\"\" required>\n" +
                "                                    <div class=\"input-group-append\">\n" +
                "                                        <span class=\"input-group-text\"> 元,返</span>\n" +
                "                                    </div>\n" +
                "                                    <input type=\"number\" min=\"0.01\" step=\"0.01\" class=\"form-control\" name=\"xf_total[]\" placeholder=\"\" required>\n" +
                "                                    <div class=\"input-group-append\">\n" +
                "                                        <span class=\"input-group-text\"> 元</span>\n" +
                "                                    </div>\n" +
                "                                    <div class=\"input-group-append\">\n" +
        ...
        function fxType() {
            var val=$("[name='fx_type']:checked").val(),xf1Item=$('#xf1Item'),xf2Item=$('#xf2Item'),xf3Item=$('#xf3Item');
            console.log(val);
            switch (val){
                case '1':
                    xf1Item.show();
