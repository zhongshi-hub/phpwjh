    ...
    <div class="view view-main">
        <div class="navbar">
            <div class="navbar-inner">
                <?php if($_GET['vs']=='extension'){ ?>
                <div class="left"><a href="#" onclick="location.href='<?php echo U('Plugs/Extension/regIndex');?>'" class="back link"> <i class="icon icon-back"></i><span>返回</span></a></div>
                <?php }else{ ?>
                <div class="left"><a href="#" onclick="location.href='<?php echo U('index');?>'" class="back link"> <i class="icon icon-back"></i><span>返回</span></a></div>
                <?php } ?>

                <div class="center sliding">小微入网</div>
                <div class="right">
        ...
        <div class="pages navbar-through toolbar-through">
            ...
            <div data-page="form" class="page">
                ...
                <div class="page-content">
                    ...
                    <?php if($_GET['vs']=='extension'){ ?>
                    <form id="form-<?php echo ($_SESSION['Reg']['codes']); ?>-par" class="store-data ajax-submit" method="post" action="<?php echo U('entensionParSave',array('Debug'=>1));?>">
                    <?php }else{ ?>
                        <form id="form-<?php echo ($_SESSION['Reg']['codes']); ?>-par" class="store-data ajax-submit" method="post" action="<?php echo U('par_save');?>">
                    <?php } ?>
                        <input type="hidden" name="mch_type"  value="par"/>
                        <input type="hidden" name="codes"  value="<?php echo ($_SESSION['Reg']['codes']); ?>" />
                        <input type="hidden" name="wx_headimgurl"  value="<?php echo ($_SESSION['Reg']['user_info']['headimgurl']); ?>" />
                        <input type="hidden" name="wx_nickname"  value="<?php echo ($_SESSION['Reg']['user_info']['nickname']); ?>" />
                        <input type="hidden" name="wx_openid"  value="<?php echo ($_SESSION['Reg']['user_info']['openid']); ?>" />
                        <div class="content-block-title">信息验证</div>
                        ...
                        <div class="list-block">
                            <ul>
                                ...
                                <!--<li>-->
                                    <!--<div class="item-content">-->
                                        <!--<div class="item-inner">-->
                                            <!--<div class="item-title label">个体户名称</div>-->
                                            <!--<div class="item-input">-->
                                                <!--<input type="text" name="qy_name" value="" placeholder="个体户全称 与营业执照上一致" required/>-->
                                            <!--</div>-->
                                        <!--</div>-->
                                    <!--</div>-->
                                <!--</li>-->
                                    ...
                                    <!--<a href="#" data-searchbar="true" data-back-text="返回" data-searchbar-cancel="取消"-->
                                       ...
                                       <!--class="item-link smart-select">-->
                                        <!--<select name="industry">-->
                                            ...
                                            <!--<?php if(is_array($par_industry)): $i = 0; $__LIST__ = $par_industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                        ...
                        <div class="list-block ">
                            <ul>
                                ...
                                <li>
                                    <div class="item-content">
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input">
                                                <input type="text" name="bank_name" value="" placeholder="请输入开户姓名(收款人)" required/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="item-content">
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input">
                                                <input type="text" name="card_val" value="" placeholder="请输入身份证号(收款人)" required/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="item-content">
                                        <div class="item-inner">
                                            <div class="item-title label">证件有效期</div>
                                            <div class="item-input">
                                ...
                                <li id="per_tel">
                                    <div class="item-content">
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input">
                                                <input type="tel" name="bank_tel" value="" placeholder="请输入银行卡预留手机号" required/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <!-- <div class="content-block-title">辅助信息</div>
                         <div class="list-block ">
                             <ul>
                                <li>
                                     <div class="item-content">
                                         <div class="item-inner">
                                             <div class="item-title label">身份证有效期</div>
                                             <div class="item-input">
                                                 <input type="date" name="card_etime" placeholder="身份证有效期限"
                                                        style="width: 74%;float:left;"  required/>
                                                 <button type="button" class="button" style="width: 25%;float:right;margin-top: 7px;"
                                                         onclick="ToDates();">永久
                                                 </button>
                                             </div>
                                         </div>
                                 ...
                                 <li>
                                     <div class="item-content">
                                         <div class="item-inner">
                                             <div class="item-title label">信用卡号</div>
                                             <div class="item-input">
                                                 <input type="tel" name="credit_card" value="" placeholder="通道提升额度!(非必填)"/>
                                             </div>
                                         </div>
                                     </div>
                                 </li>
                        ...
                        <!--<div class="content-block-title" style="margin-bottom: 0px;margin-top: 0px;color: red">注:个体户非法人对私须填写授权书 结算是法人账户 <p>无需填写<span style="color: #044aff" data-popover=".popover-xun-sqh" class="open-popover" > (授权书使用说明及下载)</span></p></div>-->
                        ...
                        <div class="content-block">
                            <div class="row">
                                ...
                                <div class="col-50 upload_border" id="img-s" onclick="IMG_UPLOAD('s')">
                                    <input type="hidden" name="img-s" value="">
                                    <i class="f7-icons" >camera</i>
                                    <p>收款人手持身份证(正面)</p>
                                </div>
                            </div>
                        ...
                        <div class="content-block-title">门店验证照片</div>
                        <div class="content-block">
                            <div class="row">
                            ...
                            <!--<div class="content-block-title" style="margin-top: 10px">商户协议照</div>-->
                            <!--<div class="content-block">-->
                                <!--<div class="row">-->
        ...
        <script>
            ...
            var code_id= "<?php echo ($_SESSION['Reg']['codes']); ?>";
            $(function () {
                UpImage_Val();
                bankChange();
                xy_status();
                $('[name="xy-box"]').change(xy_status);
            });
