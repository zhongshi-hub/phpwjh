...
<head>
    ...
    <title><?php echo ($_domain['web_name']); ?>代理登录</title>
...
<section class="g-flexview">
    ...
    <section class="g-scrollview">
        ...
        <form action="<?php echo U('agent');?>">
            ...
            <div class="m-button">
                <div style="text-align: right;font-size: 14px;margin-right: 5px"><a href="<?php echo U('agent_pass');?>" style="color: #097cff"><i class="icon-question"></i>忘记密码</a></div>
