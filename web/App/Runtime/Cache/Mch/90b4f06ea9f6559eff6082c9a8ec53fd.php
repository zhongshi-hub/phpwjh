...
<head>
    ...
    <title><?php echo ($_domain['web_name']); ?>店员登录</title>
...
<section class="g-flexview">
    ...
    <section class="g-scrollview">
        ...
        <form action="<?php echo U('store');?>">
            ...
            <div class="m-button">
                <div style="text-align: right;font-size: 14px;margin-right: 5px"><a href="<?php echo U('store_pass');?>" style="color: #097cff"><i class="icon-question"></i>忘记密码</a></div>
