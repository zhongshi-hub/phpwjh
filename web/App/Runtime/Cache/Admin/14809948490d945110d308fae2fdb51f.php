            ...
            <div class="fluid">
                <div class="panel">
                    <div id="demo-email-list" class="panel-body">
                        <h1 class="page-header text-overflow pad-btm">全部消息</h1>
                        <hr class="hr-sm">
                        <ul id="demo-mail-list" class="mail-list">
                            <?php if(is_array($data)): foreach($data as $key=>$v): if(($v["is_xing"]) == "0"): ?><li class="mail-attach" onclick="detail(<?php echo ($v["id"]); ?>)" style="cursor: pointer">
                                        <?php else: ?>
                                    <li class="mail-starred" onclick="detail(<?php echo ($v["id"]); ?>)" style="cursor: pointer"><?php endif; ?>
                                <div class="mail-star"><a><i class="demo-psi-star"></i></a></div>
                                <div class="mail-from"><?php echo ($v["type"]); ?></div>
                                <div class="mail-time" style="width: 120px"><?php echo ($v["ctime"]); ?></div>
...
<script>
    function detail(id) {
        window.location.href="<?php echo U('detail');?>/id/"+id;
    }
</script>
</div>
<footer id="footer">
