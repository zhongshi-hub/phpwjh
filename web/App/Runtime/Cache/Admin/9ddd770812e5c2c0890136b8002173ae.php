...
<div id="content-container">
    <div id="page-content">
        <div class="panel">
            <form method="post" action="<?php echo U('Auditing_save');?>">
                <div class="panel-body">
                    <p style="border-bottom: solid 1px #E4E4E4;font-size: 16px;padding-bottom: 5px;">编辑基本信息</p>
                    <div class="row">
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">负责人(如企业为法人)</label>
                                <input class="form-control" type="text" name="mch_card_name" value="<?php echo ($data["mch_card_name"]); ?>" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">负责人身份证(如企业为法人)</label>
                    ...
                    <div class="row">
                        ...
                        <?php if(($mccData) != "0"): ?><div class="col-sm-3">
                                <div class="form-group">
                ...
                <div class="panel-footer text-justify">
                    <a class="btn btn-warning" href="<?php echo U('Auditing_detail',array('id'=>$_GET['id']));?>">取消编辑并返回上一层</a>
...
<script>
    $(function() {
        $('#pos_mcc,#mch_bus_type,#mch_industry,#mch_bank_list,#mch_bank_provice,#rate,#provice').chosen({search_contains:true,no_results_text: '没有找到相关的数据'});
