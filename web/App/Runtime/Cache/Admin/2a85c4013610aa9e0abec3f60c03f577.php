                                ...
                                <!--<div class="col-sm-3">-->
                                    <!--<div class="form-group">-->
                                        ...
                                        <!--<select data-placeholder="请选择..."  tabindex="2" class="form-control" name="type">-->
                                            ...
                                            <!--<option value="wx">微信刷脸设备</option>-->
                                            <!--<option value="ali">支付宝刷脸设备</option>-->
                                        <!--</select>-->
                                    <!--</div>-->
                                <!--</div>-->
                ...
                <!--<div class="pad-btm form-inline">-->
                    <!--<div class="row">-->
                        <!--<div class="col-sm-6 text-xs-center">-->
                            <!--<div class="form-group">-->
                                <!--<a href="<?php echo U('adds');?>" class="btn btn-purple"><i class="demo-pli-add icon-fw"></i>添加设备</a>-->
                            <!--</div>-->
                        <!--</div>-->
                ...
                <!--<table  class="table table-bordered table-hover toggle-circle table-vcenter" data-page-size="7">-->
                    ...
                    <!--<?php if(is_array($data)): foreach($data as $key=>$v): ?>-->
                        <!--<tr>-->
                            ...
                            <!--</td>-->
                            <!--<td class="text-center">-->
                                <!--<?php echo ($v["device_number"]); ?>-->
                            <!--</td>-->
                            <!--<td class="text-center">-->
                                <!--<?php echo ($v["device_sn"]); ?>-->
                            <!--</td>-->
                            <!--<td class="text-center"><?php $ag=agentField($v['aid'],'user_phone'); echo $ag?$ag:"-&#45;&#45;"; ?></td>-->
                            <!--<td class="text-center"><?php $seller=Get_Seller($v['mid']); echo $seller['mch_name']?$seller['mch_name']:"-&#45;&#45;"; ?></td>-->
                            <!--<td class="text-center"><?php $store=Get_Store($v['store_id']); echo $store['name']?$store['name']:"-&#45;&#45;"; ?></td>-->
                            ...
                            <!--<td class="text-center">-->
                                <!--<a href="<?php echo U('edits',['id'=>$v['id']]);?>" class="btn btn-sm btn-default btn-active-primary">-->
                                    <!--编辑-->
                                <!--</a>-->
                            <!--</td>-->
                        <!--</tr>-->
...
<script>
    ...
    $(".status_switch").change(function () {
        ...
        var actionurl = "<?php echo U('deviceStatus');?>";
