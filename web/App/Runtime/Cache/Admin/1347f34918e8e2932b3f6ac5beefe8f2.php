            ...
            <form method="post" action="" ajax="yes">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div  class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">广告图片(建议920 × 1136像素)</label>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" min="10" name="sort" value="<?php echo ($data["sort"]); ?>" required>
                                <span>数字格式 值越大 越在前</span>
                            </div>
                        </div>
                    </div>
                    <div class="panel-footer text-right">
                        <input name="id" type="hidden" value="<?php echo ($data["id"]); ?>">
                        <input name="type" type="hidden" value="wx">
