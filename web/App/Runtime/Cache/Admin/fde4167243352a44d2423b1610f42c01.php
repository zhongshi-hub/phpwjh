    ...
    <div id="page-content">
        <div class="panel">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <form method="post" action="<?php echo U('statistics');?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select data-placeholder="请选择..." id="type" tabindex="2" class="form-control" name="type">
                                            ...
                                            <option value="wx" <?php if(($data["type"]) == "wx"): ?>selected="selected"<?php endif; ?> >微信</option>
                                            <option value="ali" <?php if(($data["type"]) == "ali"): ?>selected="selected"<?php endif; ?>>支付宝</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <p><?php echo ((isset($count) && ($count !== ""))?($count):'0'); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo (number_format($refund_sum,2)); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo ((isset($refund_count) && ($refund_count !== ""))?($refund_count):'0'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo (number_format($wx_sum,2)); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo ((isset($wx_count) && ($wx_count !== ""))?($wx_count):'0'); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo (number_format($ali_sum,2)); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 eq-box-sm">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p><?php echo ((isset($ali_count) && ($ali_count !== ""))?($ali_count):'0'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
