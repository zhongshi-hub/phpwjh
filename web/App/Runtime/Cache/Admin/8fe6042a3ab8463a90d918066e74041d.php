        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="alert alert-danger">
                    <strong>说明:</strong>
                    <p>分润规则: 如自己是一级 所有交易(一级+二级+三级...) 按照通道成本费率计算 </p>
                    <p>计算规则: ((商户交易终端费率-代理当前通道成本)*交易金额)/1000 保留小数点后两位</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 table-toolbar-left">
                            <form method="post" action="" ajax="n">
                                ...
                                <button class="btn btn-info" value="ccl" name="export" type="submit"> <i class="fa fa-download"></i>导出所有分润明细</button>
                            </form>
                        </div>
                    </div>
                </div>
                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                    ...
                    <tr>
                        ...
                        <th class="text-center">层次代理</th>
                        <th class="text-center">所属门店</th>
                        <th class="text-center">订单号</th>
                        <th class="text-center">交易时间</th>
                        <th class="text-center">交易金额</th>
                        <th class="text-center">所属通道</th>
                        <th class="text-center">所属代理成本</th>
                        <th class="text-center">商户终端费率</th>
                        <th class="text-center">分润规则</th>
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            ...
                            <td class="text-center"><?php echo (agent_name($v["aid"])); ?></td>
                            <td class="text-center" style="width: 120px"><?php $store=Get_Store($v['store_id']); echo $store['name']; ?></td>
                            <td class="text-center"><?php echo ($v['out_trade_no']); ?></td>
                            <td class="text-center"><?php echo (date('Y-m-d H:i:s',$v['time_end'])); ?></td>
                            <td class="text-center"><span class="label label-danger" style="font-size:12px;font-weight:1;border-radius: 5px;"><?php echo ($v['total']); ?></span></td>
                            <td class="text-center"><?php echo (alleys_name($v["alleys"])); ?></td>
                            <td class="text-center"><?php echo ($v["cost"]); ?>‰</td>
                            <td class="text-center"><?php echo ($v["term"]); ?>‰</td>
                            <td class="text-center"><?php echo AlleyFrType($v['alleys'],1); ?></td>
                            <td class="text-center">
                                 <span class="label label-danger" style="font-size:12px;font-weight:1;border-radius: 5px;"><?php echo ($v["money"]); ?></span>
                            </td>
