...
<head>
    <title><?php echo ($_domain['web_name']); ?>移动支付管理系统</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="Description" content="<?php echo ($_domain['web_name']); ?>移动支付管理系统">
...
<div class="lc-block toggled">
    ...
    <div style="text-align: center;font-weight: 400;"> <?php echo ($_domain['web_name']); ?> <?php echo ($_domain['web_domain']); ?> 版权所有</div>
