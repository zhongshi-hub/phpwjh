            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-xs-center">
                            <div class="form-group">
                                <a class="btn btn-purple" href="<?php echo U('AdDataAdd');?>"><i class="demo-pli-add icon-fw"></i>添加广告位</a>
                            </div>
                        </div>
                ...
                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle table-vcenter" data-page-size="7">
                    ...
                    <tr>
                        ...
                        <th class="text-center">是否在执行时间内</th>
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            ...
                            <td class="text-center">
                                <?php switch($v["type"]): case "pay_success": ?>支付完成页面<?php break;?>
                                    <?php case "mch_notify": ?>商家收款通知<?php break;?>
                                    <?php case "pay_notify": ?>用户支付成功通知<?php break;?>
                                    <?php default: ?>默认<?php endswitch;?>
                            </td>
                            <td class="text-center"><?php echo ($v["start_time"]); ?></td>
                            <td class="text-center"><?php echo ($v["end_time"]); ?></td>
                            <td class="text-center"> <?php if(($v["is_time"]) == "1"): ?><span  class="label label-primary" style="font-size:12px;font-weight:1;border-radius: 5px;cursor: pointer;">在广告日期内</span>
                                <?php else: ?>
                                <span class="label label-default" style="font-size:12px;font-weight:1;border-radius: 5px;cursor: pointer;">不在日期内</span><?php endif; ?></td>
                            <td class="text-center"> <?php if(($v["status"]) == "1"): ?><span  class="label label-primary" style="font-size:12px;font-weight:1;border-radius: 5px;cursor: pointer;">正常</span>
                                <?php else: ?>
                                <span class="label label-default" style="font-size:12px;font-weight:1;border-radius: 5px;cursor: pointer;">禁用</span><?php endif; ?></td>
                            <td class="text-center">
                                <button class="btn btn-purple btn-sm" type="button" onclick="edit(<?php echo ($v["id"]); ?>)" >编辑</button>
                            </td>
...
<script>
    ...
    function edit(id) {
        window.location.href='<?php echo U("AdDataAdd");?>/id/'+id;
    }
