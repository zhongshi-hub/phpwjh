                        ...
                        <form class="form-inline" method="post">
                            <table class="table table-vcenter">
                                <tr>
                                    ...
                                    <td>
                                        <select data-placeholder="请选择..." id="demo-chosen-select" tabindex="2" name="group_ids[]" style="width: 300px;" required="required">
                                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['title']); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        <a href="<?php echo U('Admin/Rule/rule_group');?>" class="btn">添加(角色)管理组</a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>登录账户</th>
                                ...
                                <tr>
                                    <th>成员姓名</th>
                                    <td>
                                        <input class="form-control" type="text" name="name" required="required" placeholder="备注 可以中文">
                                    </td>
                                </tr>
                                <tr>
                                    <th>手机号</th>
