            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-xs-center">
                            <div class="form-group">
                                <a class="btn btn-purple" href="<?php echo U('wxQwAdDataSet');?>"><i class="demo-pli-add icon-fw"></i>添加广告位</a>
                            </div>
                        </div>
                ...
                <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle table-vcenter" data-page-size="7">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            <td class="text-center"><img src="<?php echo ($v["img"]); ?>" title="点击放大查看" width="30" height="30"onclick="IMG('<?php echo ($v["img"]); ?>')" style="cursor:pointer"></td>
...
<script>
    ...
    function edit(id) {
        window.location.href='<?php echo U("wxQwAdDataSet");?>/id/'+id;
    }
