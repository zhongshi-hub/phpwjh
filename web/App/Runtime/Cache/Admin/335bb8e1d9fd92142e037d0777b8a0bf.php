                  ...
                  <div class="panel">
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 text-xs-center">
                                    <div class="form-group">
                                        <a href="<?php echo U('Admin/User/add_user');?>"><button id="demo-btn-addrow" class="btn btn-purple"><i class="demo-pli-plus"></i>添加后台成员</button></a>
                                    </div>
                                </div>
                        ...
                        <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                            <thead>
                                <tr>
                                    <th data-sort-initial="true" data-toggle="true">登录账户</th>
                                    <th>联系邮箱</th>
                                    <th>成员姓名</th>
                                    <th>联系电话</th>
                                    <th>(角色)管理组</th>
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        ...
                                        <td>
                                            <?php if($v['is_sys'] == 1 ): ?><span style="color: red">系统超级管理员</span>
                                             <?php else: ?>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/User/edit_user',array('id'=>$v['id']));?>">修改</a>
                                        </td>
