...
<div id="content-container">
    <div id="page-content">
        <div class="panel">
            <form id="in_form" method="post" action="<?php echo U('alterInfo');?>">
            <div class="panel-body">
                <p style="border-bottom: solid 1px #E4E4E4;font-size: 16px;padding-bottom: 5px;"><?php if(($_GET['type']) == "bank"): ?>变更银行卡<?php else: ?>变更联系信息<?php endif; ?></p>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="control-label">商户号<span class="ccl_r">*</span></label>
                            <input class="form-control" type="text" name="sub_mch_id" value="<?php echo ($data["sub_mch_id"]); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"  value="<?php echo ($data["id_card_name"]); ?>" readonly>
                        </div>
                    </div>
                </div>
                <?php if(($_GET['type']) == "bank"): ?><div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                ...
                <?php else: ?>
                    ...
                    <input type="hidden" name="type" value="no"><?php endif; ?>
            </div>
