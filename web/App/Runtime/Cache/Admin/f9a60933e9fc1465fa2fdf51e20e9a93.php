            ...
            <div class="panel-body">
                <form class="form-inline" method="post">
                    ...
                    <table class="table table-vcenter">
                        <tr>
                            <th width="150px">管理组</th>
                            <td>
                                <?php if($user_data['is_sys'] == 1 ): ?><select data-placeholder="请选择..." id="demo-chosen-select" tabindex="2" name="group_ids[]" style="width: 300px;" disabled>
                                            <option selected="selected">系统超级管理员</option>
                                    </select>

                                <?php else: ?>
                                    <select data-placeholder="请选择..." id="demo-chosen-select" tabindex="2" name="group_ids[]" style="width: 300px;" required>
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if(in_array(($v['id']), is_array($group_data)?$group_data:explode(',',$group_data))): ?>selected="selected"<?php endif; ?>><?php echo ($v['title']); ?></option><?php endforeach; endif; ?>
                                    </select><?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>登录账户</th>
                            <td>
                                <input class="form-control" type="text" name="username" value="<?php echo ($user_data['username']); ?>" required="required" placeholder="登录账号">
                            </td>
                        </tr>
                        <tr>
                            <th>成员姓名</th>
                            <td>
                                <input class="form-control" type="text" name="name" value="<?php echo ($user_data['name']); ?>" required="required" placeholder="备注 可以中文">
                            </td>
                        </tr>
                        <tr>
                            <th>手机号</th>
                        ...
                        <tr>
                            <th>邮箱</th>
                            <td>
                                <input class="form-control" type="email" name="email" value="<?php echo ($user_data['email']); ?>" required="required">
                            </td>
                        </tr>
                        <tr>
                            <th>初始密码</th>
                            <td>
                                <input class="form-control" type="text" name="password" placeholder="登录密码 如不改密码；留空即可">
                            </td>
                        </tr>
                        <?php if($user_data['is_sys'] != 1 ): ?><tr>
                            <th>状态</th>
                            <td>
                                <span class="inputword">允许登录</span>
                                <input style="width: 50px!important;" class="xb-icheck" type="radio" name="status" value="1" <?php if(($user_data['status']) == "1"): ?>checked="checked"<?php endif; ?> >
                                &emsp;
                                <span class="inputword">禁止登录</span>
                                <input style="width: 50px!important;" class="xb-icheck" type="radio" name="status" value="0" <?php if(($user_data['status']) == "0"): ?>checked="checked"<?php endif; ?> >
                            </td>
                        </tr><?php endif; ?>
                        <tr>
                            <th></th>
