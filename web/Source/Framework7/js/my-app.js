...
function UpImage_Val() {
    var array = ['z', 'p', 's', 'm1', 'm2', 'm3', 'bank'];
    var storedData = myApp.formGetData("form-"+code_id+"-img");
    var url='http://file.xunmafu.com/Upload/attachment/2017-11-23/';
    if(storedData) {
        for (var k = 0, length = array.length; k < length; k++) {
            src = storedData['img-' + array[k]];
            var src_demo = ['WJEPKIUJE6NG0FKO698A.jpg','E03139IEHKB9BVHKIL5D.jpg','A33ENAI6K0936LOHRHMH.jpg','mentou.jpg','neijing.jpg','shouyintai.jpg','F889PLCX93NGO5FAJEMM.jpg'];
        ...
        var src = ['WJEPKIUJE6NG0FKO698A.jpg','E03139IEHKB9BVHKIL5D.jpg','A33ENAI6K0936LOHRHMH.jpg','mentou.jpg','neijing.jpg','shouyintai.jpg','F889PLCX93NGO5FAJEMM.jpg'];
        for (var k = 0, length = array.length; k < length; k++) {
    ...
    var xun_my = [
        {
            ...
            onClick: function () {
                myApp.confirm('缓存清空后需要重新填写!您确定要清空本页缓存数据吗?', function () {
                    myApp.formDeleteData('form-'+code_id);
                    myApp.formDeleteData('form-'+code_id+'-img');
...
function setForm() {
    ...
    myApp.formStoreData("form-"+code_id+"-img", formData);
}
