    ...
    var methods = {
        ...
        init: function(options) {
            ...
            var create={
                ...
                html:function(data){
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $.each(data[i],function(index,val){
                            html+='<li data-html="'+val.name+'" data-value="'+val.id+'" data-id="'+index+'">'+val.name+'</li>';
                        });
                ...
                htmlLi:function(data){
                    ...
                    $.each(data,function(index,val){
                        str+='<li data-html="'+val.name+'" data-value="'+val.id+'" data-id="'+index+'">'+val.name+'</li>';
                    });
                    return str;
                }
            ...
            $input.on('click',function(e){
                ...
                selector.confirm.on('touchstart click',function(e){
                    ...
                    $.each(selector.listUl,function(index,ele){
                        ...
                        if($active.length>0){
                            ...
                            selector.inputBox.data('html'+index,$active.data('html'));
                            str.push($active.text());
                        }
                    });
                    if(str.length==1){
                        selector.inputBox.val(str[0]);
                    }else{
                        selector.inputBox.val(str[1]+"-"+str[0]);
                    }
                ...
                //点击确认后回调
                selector.confirm.on("touchend" ,function(){
                   toGetNext();
                });
                //点击取消
