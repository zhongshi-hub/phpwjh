...
class FaceOrderQuery extends WxPayDataBase{
 ...
 * Class FacePay
 */
class FacePay extends WxPayDataBase
{
 ...
 * Class GetAuthInfo
 */
class GetAuthInfo extends WxPayDataBase
{

	public function SetVersion($value)
	{
		$this->values['version'] = $value?$value:1;
	}

	public function SetSign_type($value)
	{
		$this->values['sign_type'] = $value?$value:'MD5';
	}
	...
	public function SetStore_id($value){
		$this->values['store_id'] = $value;
	}

	public function IsStore_id()
	{
		return array_key_exists('store_id', $this->values);
	}

	public function SetStore_name($value){
		$this->values['store_name'] = $value;
	}

	public function IsStore_name()
	{
...
{	
	...
	**/
     ...
     * @return true 或 false
     **/
    public function IsClient_idSet()
    {
