...
class WxPayApi
{
	 ...
	 * @throws WxPayException
	 */
	public function faceOrderQuery($input,$timeOut=5){
		$url="https://api.mch.weixin.qq.com/pay/facepayquery";
		$input->Set('appid',WxPayConfig::APPID);
		$input->Set('mch_id',WxPayConfig::MCHID);
		$input->Set('nonce_str',self::getNonceStr());
	 ...
	 * @throws WxPayException
	 */
	public static function facePay($input,$timeOut=5){
	 ...
	 * @throws WxPayException
	 */
	public static  function authInfo($input,$timeOut=5){
		...
		$result = WxPayResults::Init($response);
		self::reportCostTime($url, $startTimeStamp, $result);//上报请求花费时间
		$result['api_key']=WxPayConfig::KEY;
		return $result;
	}
