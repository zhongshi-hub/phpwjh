...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后一页','theme'=>'<ul class="pagination pull-right">  %upPage%  %first%  %prePage%  %linkPage%  %nextPage% %end% %downPage% <li> <a href="javascript:;">共 %totalRow% %header%</a></li> <li><a href="javascript:;">第 %nowPage% 页/共 %totalPage% 页</a></li></ul>');
    // 默认分页变量名
    protected $varPage;
